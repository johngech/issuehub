...
| Adapter         | Command                                                                                              |
| --------------- | ---------------------------------------------------------------------------------------------------- |
| Built-in Kysely | `bunx @better-auth/cli@latest migrate` (applies directly)                                            |
| Prisma          | `bunx @better-auth/cli@latest generate --output prisma/schema.prisma` then `bunx prisma migrate dev` |
| Drizzle         | `bunx @better-auth/cli@latest generate --output src/db/auth-schema.ts` then `bunx drizzle-kit push`  |
